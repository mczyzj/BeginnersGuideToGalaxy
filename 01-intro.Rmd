...
Now every time you need functions from specific library you can just tick box next to package name, and RStudio will load it for you.
...
```
* Tables and figures are references are clickable e.g. see Table \@ref(tab:nice-tab) or see Figure \@ref(fig:option-settings).
